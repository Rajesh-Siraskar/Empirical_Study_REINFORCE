...
%% ----------------------------------------------------------------------------------------
\def\Version{\today { } V 2.03} % Env. / reward fn.
...
%			Simulated  - No noise &\textbf{0.842} &\textbf{0.878} &\textbf{0.838} & \textbf{0.834} & & 0.424 &0.451 &0.423 &0.421 & &0.426 &0.674 &0.471 &0.410 & &0.504 &0.200 &0.271&0.360\\
%			Simulated  - Low noise &\textbf{0.777} &\textbf{0.929} &\textbf{0.834} & \textbf{0.796} & & 0.465 &0.423 &0.409 &0.427 & &0.421 &0.338 &0.270 &0.283 & &0.482 &0.236 &0.296&0.369\\
%			Simulated  - High noise &\textbf{0.798} &\textbf{0.940} &\textbf{0.851} & \textbf{0.816} & & 0.358 &0.281 &0.256 &0.272 & &0.447 &0.519 &0.380 &0.360 & &0.514 &0.207 &0.286&0.382\\ \midrule
%			
%			PHM C01 SS - No noise &0.478 &0.363 &0.400 & 0.439 & & \textbf{0.501} &\textbf{0.500} &\textbf{0.493} &\textbf{0.496} & &0.472 &0.807 &0.568 &0.490 & &0.440 &0.417 &0.387&0.395\\
%			PHM C01 SS - Low noise &0.507 &0.311 &0.332 & 0.383 & & \textbf{0.503} &\textbf{0.598} &\textbf{0.535} &\textbf{0.513} & &0.393 &0.502 &0.351 &0.317 & &0.522 &0.338 &0.388&0.448\\
%			PHM C01 SS - High noise &\textbf{0.693} &\textbf{0.562} &\textbf{0.579} & \textbf{0.623} & & 0.266 &0.282 &0.267 &0.262 & &0.458 &0.525 &0.400 &0.384 & &0.456 &0.369 &0.372&0.400\\ \hdashline
%			
%			PHM C04 SS - No noise &\textbf{0.751} &\textbf{0.878} &\textbf{0.784} & \textbf{0.757} & & 0.487 &0.442 &0.449 &0.463 & &0.439 &0.684 &0.472 &0.411 & &0.500 &0.510 &0.469&0.473\\
%			PHM C04 SS - Low noise &\textbf{0.662} &\textbf{0.756} &\textbf{0.672} & \textbf{0.657} & & 0.409 &0.455 &0.428 &0.416 & &0.411 &0.500 &0.370 &0.341 & &0.488 &0.280 &0.324&0.386\\
%			PHM C04 SS - High noise &\textbf{0.611} &\textbf{0.713} &\textbf{0.620} & \textbf{0.598} & & 0.518 &0.607 &0.552 &0.530 & &0.358 &0.451 &0.325 &0.294 & &0.428 &0.262 &0.286&0.333\\ \hdashline
%			
%			PHM C06 SS - No noise &\textbf{0.830} &\textbf{0.726} &\textbf{0.754} & \textbf{0.792} & & 0.517 &0.509 &0.507 &0.511 & &0.360 &0.309 &0.256 &0.258 & &0.409 &0.248 &0.275&0.321\\
%			PHM C06 SS - Low noise &0.205 &0.279 &0.228 & 0.212 & & \textbf{0.510} &\textbf{0.577} &\textbf{0.530} &\textbf{0.516} & &0.434 &0.266 &0.266 &0.296 & &0.417 &0.181 &0.232&0.294\\
%			PHM C06 SS - High noise &\textbf{0.709} &\textbf{0.843} &\textbf{0.759 }& \textbf{0.726} & & 0.316 &0.324 &0.311 &0.308 & &0.449 &0.518 &0.400 &0.375 & &0.388 &0.222 &0.265&0.317\\ \midrule
%			
%			PHM C01 MS - No noise &\textbf{0.835} &\textbf{0.652} &\textbf{0.656} & \textbf{0.716} & & 0.461 &0.444 &0.397 &0.404 & &0.384 &0.558 &0.393 &0.348 & &0.513 &0.383 &0.416&0.460\\
%			PHM C04 MS - No noise &\textbf{0.739} &0.255 &0.359 & \textbf{0.494} & & 0.498 &\textbf{0.589 }&\textbf{0.490} &0.470 & &0.323 &0.209 &0.160 &0.168 & &0.499 &0.393 &0.421&0.457\\
%			PHM C06 MS - No noise &\textbf{0.864} &0.356 &0.469 & \textbf{0.616} & & 0.501 &\textbf{0.713} &\textbf{0.578} &\textbf{0.527} & &0.489 &0.705 &0.529 &0.479 & &0.523 &0.488 &0.485&0.498\\
%			
%			\bottomrule
%		\end{tabular}
%		\caption{Model performance comparison all variants of the environments, over 10 rounds of training.}
%		\label{tbl:DetailedMetrics_BOLD}
%	\end{table*}
%\end{landscape}
