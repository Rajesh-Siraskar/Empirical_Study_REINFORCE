...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{PHMMSdata.pdf}  
...
\begin{table*}[!htb]\centering
	...
	\label{tbl:PHMMS}
\end{table*}
This environments offers the highest difficulty and the most realistic scenario. We use real data, from multiple sensors. As with other scenarios, we used untuned, default settings of all algorithms. Surprisingly, the tool replacement precision was very high at 0.813, Table .  

 is the Real data offers a more challenging environment. Despite this, in Table \ref{tbl:PHMSS}, we notice that REINFORCE  still performs better than the other algorithms. The margins are understandably lower: precision by 0.155, recall by 0.097, F1 by 0.117 and F-beta (0.5) by 0.130. 
