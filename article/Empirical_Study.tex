...
This paper is structured as follows: \textcolor{red}{In the next section we provide necessary background and definitions. Section 3 discusses xxx, while Section 4 xxx demonstrates. A summary and conclusions are given in Section 5.}
...
\subsection{Network architecture and basic hyper-parameters}
