...
%$$$
%##
\textcolor{red}{xxxxxxxxxxxxxxxxxxx} hlIndeed, RL algorithms have been shown to be incredibly sensitive to hyperparameters and
architectures of deep neural networks (Henderson et al., 2018; Andrychowicz et al., 2021;
Engstrom et al., 2020),

Henderson et al. (2018) identified this and showed that different
codebases for the same algorithm produced markedly different results. Furthermore, Engstrom
et al. (2020) investigated implementation details in popular policy gradient algorithms (PPO,
Schulman et al. (2017a) and TRPO Schulman et al. (2015)), where details such as reward
normalization were found to play a crucial role in RL performance

Henderson, P., Islam, R., Bachman, P., Pineau, J., Precup, D.,  Meger, D. (2018). Deep reinforcement
learning that matters. In Proceedings of the Thirty-Second AAAI Conference
on Artificial Intelligence, (AAAI), pp. 3207–3214. AAAI Press
